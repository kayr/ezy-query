...
public class ParsedSql {
  ...
  /** The parameter names in the parsed SQL statement, in order of appearance. */
  private final List<String> parameterNames = new ArrayList<>();

  /** The parameter indexes in the parsed SQL statement, in order of appearance. */
  private final List<int[]> parameterIndexes = new ArrayList<>();

  @lombok.Setter private int namedParameterCount;
  @lombok.Setter private int unnamedParameterCount;
  @lombok.Setter private int totalParameterCount;
