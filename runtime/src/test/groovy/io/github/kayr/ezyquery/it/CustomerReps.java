...
@Generated(
    ...
    date = "2022-09-26T15:11:45.205"
)
public class CustomerReps implements EzyQuery<CustomerReps.Result> {
  public static Field<Object> FIELD_CUSTOMER_NAME = Field.of("c.customerName", "customerName", Object.class);

  public static Field<Object> FIELD_EMPLOYEE_REP = Field.of("e.employeeNumber", "employeeRep", Object.class);

  public static Field<Object> FIELD_EMPLOYEE_OFFICE = Field.of("o.addressLine1", "employeeOffice", Object.class);

  public static Field<Object> FIELD_EMPLOYEE_COUNTY = Field.of("o.country", "employeeCounty", Object.class);

  public static final CustomerReps Q = new CustomerReps();

  private final String schema = "offices o\n"
            + "LEFT JOIN employees e ON o.officeCode = e.officeCode\n"
            + "LEFT JOIN customers c ON e.employeeNumber = c.salesRepEmployeeNumber\n"
  ;
